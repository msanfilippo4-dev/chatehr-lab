  ...
  if (!ragEnabled) {
    return (
      <div className="ehr-shell p-4 text-center">
        ...
        <p className="t-small t-secondary">RAG disabled</p>
  ...
  return (
    <div className="ehr-shell overflow-hidden">
      <div className="flex items-center gap-2 px-4 py-3 bg-[#f3f7fd] border-b border-[#d6dfeb]">
        ...
        <h3 className="t-caption font-semibold text-gray-200">
        ...
        {!isLoading && chunks.length > 0 && (
          <span className="ml-auto t-micro bg-gray-800 text-gray-300 px-1.5 py-0.5 rounded-full border border-gray-700/60">
      ...
      <div className="p-3">
        {!isLoading && chunks.length === 0 && (
          <div className="text-center py-4">
            ...
            <p className="t-small t-secondary">No guidelines retrieved yet</p>
            <p className="t-micro t-tertiary mt-1">
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="t-caption font-medium text-gray-200 truncate">
                        {chunk.title}
                      </p>
                      <p className="t-micro t-secondary">{chunk.source}</p>
                    </div>
                  </div>
                  {isExpanded ? (
                ...
                {isExpanded && (
                  <div className="px-3 pb-3 border-t border-gray-700/40">
                    <p className="t-caption text-gray-300 leading-relaxed mt-2 whitespace-pre-wrap">
                      {chunk.text}
                    </p>
                    {chunk.keywords && chunk.keywords.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-2.5">
                        {chunk.keywords.slice(0, 8).map((kw, ki) => (
                          <span
                            key={ki}
                            className="t-micro bg-gray-700/60 text-gray-400 px-1.5 py-0.5 rounded"
                          >
                            {kw}
                          </span>
                        ))}
        ...
        {chunks.length > 0 && (
          <p className="t-micro t-tertiary text-center mt-3">
