      ...
      <div className="p-3 border-t border-gray-800 bg-gray-900/40 shrink-0">
        ...
        <form onSubmit={handleSubmit} className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 bg-gray-950 border border-gray-700 text-[#122033] text-sm rounded-xl pl-4 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#8C1515]/60 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed placeholder-gray-600 resize-none shadow-inner"
